...
<section class="section-4 col-1">
  <div class="grid-50">
    ...
    <div class="video">
      <iframe width="560" height="315" src="<?= $url; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="yt-video"></iframe>
